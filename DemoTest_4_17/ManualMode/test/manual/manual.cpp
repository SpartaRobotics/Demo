...
void displayGUI(int *threshold_id1, int *threshold_id2, int *threshold_id3,
				...
				int *threshold_clw, int *concurrent_id1, int *concurrent_id2,
				int *concurrent_id3, int *concurrent_id4, int *concurrent_id5,
				int *concurrent_id6);
int getkey();
...
int main(int argc, const char *argv[])
{
	...
	int concurrent_id1 = ID1_RST;
	int concurrent_id2 = ID2_RST;
	int concurrent_id3 = ID3_RST;
	int concurrent_id4 = ID4_RST;
	int concurrent_id5 = ID5_RST;
	int concurrent_id6 = ID6_RST;
	...
	*/
	...
	while (true) {
		...
		displayGUI(&threshold_id1, &threshold_id2, &threshold_id3, 
			...
			&concurrent_id1, &concurrent_id2, &concurrent_id3, 
			&concurrent_id4, &concurrent_id5, &concurrent_id6);
				   
		control.moveSpeed(1, threshold_id1, DSPEED);
		control.moveSpeed(2, threshold_id2, DSPEED);
		control.moveSpeed(3, threshold_id3, DSPEED);
		control.moveSpeed(4, threshold_id4, DSPEED);
		control.moveSpeed(5, threshold_id5, DSPEED);
		control.moveSpeed(6, threshold_id6, DSPEED);
				...
				int *concurrent_id6)
{
	...
	if (cvui::button(frame, 815, 500, "CONCURRENT MOVE")) {
		*threshold_id1 = *concurrent_id1;
		*threshold_id2 = *concurrent_id2;
		*threshold_id3 = *concurrent_id3;
		*threshold_id4 = *concurrent_id4;
		*threshold_id5 = *concurrent_id5;
		*threshold_id6 = *concurrent_id6;
	}
	...
	cvui::trackbar(frame, 250, 80, 400, threshold_id1, 0, 2100);
	cvui::trackbar(frame, 250, 150, 400, threshold_id2, 1300, 4000);
	cvui::trackbar(frame, 250, 220, 400, threshold_id3, 600, 4000);
	cvui::trackbar(frame, 250, 290, 400, threshold_id4, 0, 4095);
	cvui::trackbar(frame, 250, 360, 400, threshold_id5, 640, 3142);
	cvui::trackbar(frame, 250, 430, 400, threshold_id6, 665, 3140);
	cvui::trackbar(frame, 250, 500, 400, threshold_clw, 120, 490);
	
	cvui::trackbar(frame, 700, 80, 400, concurrent_id1, 0, 2100);
	cvui::trackbar(frame, 700, 150, 400, concurrent_id2, 1300, 4000);
	cvui::trackbar(frame, 700, 220, 400, concurrent_id3, 600, 4000);
	cvui::trackbar(frame, 700, 290, 400, concurrent_id4, 0, 4095);
	cvui::trackbar(frame, 700, 360, 400, concurrent_id5, 640, 3142);
	cvui::trackbar(frame, 700, 430, 400, concurrent_id6, 665, 3140);
